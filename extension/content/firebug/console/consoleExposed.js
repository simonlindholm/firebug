...
function createFirebugConsole(context, win)
{
    ...
    {
        Frontend.dir(context, obj);
        return Console.getDefaultReturnValue();
    };

    console.dirxml = function dirxml(obj)
    {
        Frontend.dirxml(context, obj);
        return Console.getDefaultReturnValue();
    };
    ...
    console.trace = function firebugDebuggerTracer()
    {
        ...
        Frontend.trace(context, trace);
        return Console.getDefaultReturnValue();
    };

    console.group = function group()
    {
        Frontend.group(context, arguments, true, getStackLink());
        return Console.getDefaultReturnValue();
    };

    console.groupCollapsed = function()
    {
        Frontend.group(context, arguments, false, getStackLink());
        return Console.getDefaultReturnValue();
    };

    console.groupEnd = function()
    {
        Frontend.groupEnd(context);
        return Console.getDefaultReturnValue();
    };

    console.profile = function(title)
    {
        Frontend.profile(context, title ? String(title) : null);
        return Console.getDefaultReturnValue();
    };

    console.profileEnd = function()
    {
        Frontend.profileEnd(context);
        return Console.getDefaultReturnValue();
    };
    ...
    console.count = function(key)
    {
        ...
        Frontend.count(context, strKey, getStackLink());
        return Console.getDefaultReturnValue();
    };

    console.clear = function()
    {
        Frontend.clear(context, win);
        return Console.getDefaultReturnValue();
    };
    ...
    console.timeEnd = function(name)
    {
        ...
        if (time)
        {
            ...
            Frontend.timeEnd(context, name, diff, getStackLink());
    ...
    console.timeStamp = function(label)
    {
        if (typeof label !== "string")
            label = "";
        Frontend.timeStamp(context, label, Date.now());
        return Console.getDefaultReturnValue();
    };

    console.table = function(data, columns)
    {
        Frontend.table(context, data, columns);
        return Console.getDefaultReturnValue();
    };
    ...
    {
        Frontend.log(context, args, className, getStackLink());
        return Console.getDefaultReturnValue();
    }

    function logAssert(args, category)
    {
        var msg = args && args.length ? args[0] : [Locale.$STR("Assertion")];

        var trace;
        var stack = msg && msg.stack;
        ...
        var fileName = msg && msg.fileName;
        if (typeof fileName !== "string")
            fileName = win.location.href;

        // we may have only the line popped above
        var lineNo = msg && msg.lineNumber;
        if (typeof lineNo !== "number" || (lineNo|0) !== lineNo)
            lineNo = 0;

        Frontend.logError(context, args, category, fileName, lineNo, trace);
